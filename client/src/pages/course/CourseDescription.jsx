                            ...
                            <div className="space-y-4">
                                ...
                                </div>
                                {
                                    role === "ADMIN" || data?.subscription?.status === "ACTIVE" ? (
                                        ...
                                        <button onClick={() => navigate("/checkout")} type="submit" className="mt-2 w-full bg-[#2525AD] font-semibold cursor-pointer text-lg text-white px-5 py-3 rounded-md hover:bg-[#2B59CE] transition-all ease-in-out duration-300">
                                            Subscribe
                                        </button>
                                    )
                                }
